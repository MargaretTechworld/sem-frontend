  ...
  return (
    <div className="home-about">
      ...
      >
        ...
        >
          <img className="home-img" src={imgHome1} alt="Leadership Development" />
        ...
        <motion.div
          ...
          whileHover={{ y: -10, transition: { duration: 0.3 } }}
        >
          <img className="home-img" src={imgHome2} alt="Mentorship Programs" />
        ...
        <motion.div
          ...
          whileHover={{ y: -10, transition: { duration: 0.3 } }}
        >
          <img className="home-img" src={imgHome3} alt="Tailored Consulting Services" />
