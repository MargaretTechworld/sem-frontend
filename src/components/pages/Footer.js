      ...
      <div className="home-contact-container">
        <div className="home-contact-info">
          ...
          <div className="footer-links">
            <Link to="/about" onClick={handleLinkClick}><p>About Us</p></Link>
            <Link to="/news-events" onClick={handleLinkClick}><p>News & Events</p></Link>
            <Link to="/admission" onClick={handleLinkClick}><p>Admission</p></Link>
            <Link to="/contact-us" onClick={handleLinkClick}><p>Contact</p></Link>
            <Link to="/login-page" onClick={handleLinkClick}><p>Login</p></Link>
          </div>
        </div>
